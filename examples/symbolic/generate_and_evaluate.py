...
def select_best_configuration_across_tasks(config_frame: pd.DataFrame,
    ...
    best_avg = average_measure_per_configuration[best_idx]
    return best_config.to_dict(), best_avg
...
def run(args):
    ...
    best_config_vanilla, best_avg_vanilla = select_best_configuration_across_tasks(config_frame_orig,
                                                                                   surrogates,
                                                                                   config_frame_orig.columns.values,
                                                                                   None, None, None, None)
    print('BASELINE', best_config_vanilla, best_avg_vanilla)
