...
def get_random_forest_default_search_space():
    ...
    n_estimators = ConfigSpace.Constant(classif_prefix + "n_estimators", 100)
    ...
    max_features = ConfigSpace.UniformFloatHyperparameter(classif_prefix + "max_features", 0., 1., default_value=0.5)

    max_depth = ConfigSpace.UnParametrizedHyperparameter(classif_prefix + "max_depth", "None")
    ...
    min_weight_fraction_leaf = ConfigSpace.UnParametrizedHyperparameter(classif_prefix + "min_weight_fraction_leaf", 0.)
    max_leaf_nodes = ConfigSpace.UnParametrizedHyperparameter(classif_prefix + "max_leaf_nodes", "None")
